...
<header>
    <div class="d-sm-flex menu1 position-relative">
        ...
        <button class="btn btn-light btn-sm position-absolute 
              top-50 translate-middle-y d-sm-none me-2" style="right: 0; margin-top: 2px; padding: 4px 8px;" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasMenu" aria-controls="offcanvasMenu">
